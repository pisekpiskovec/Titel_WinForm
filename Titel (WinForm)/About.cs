...
namespace Titel_WinForm
{
    ...
    {
        public About() { InitializeComponent(); rbTemplRevA.Checked = Properties.Settings.Default.templExtended; rbTempl.Checked = !rbTemplRevA.Checked; }
        ...
        private void rbTemplRevA_CheckedChanged(object sender, EventArgs e) { Properties.Settings.Default.templExtended = rbTemplRevA.Checked; }
    }
}
